...
/*   Updated: 2024/09/27 14:10:44 by hoatran          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	init_assets(t_cub3D *cub3d)
{
	...
	a->door = load_png(cub3d->mlx, "assets/textures/door.png");
	...
	if (
		...
		|| a->door == NULL || a->sprite_wand == NULL || a->walls[0] == NULL
		|| a->walls[1] == NULL || a->walls[2] == NULL || a->walls[3] == NULL
	)
	{
